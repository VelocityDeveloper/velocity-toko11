...
function velocitychild_theme_setup()
{
	...
	if (class_exists('Kirki')) :
		...
		Kirki::add_panel('panel_toko11', [
			'priority'    => 10,
			'title'       => esc_html__('Toko 11', 'justg'),
...
add_action('velocitytoko_product_loop','velocitytoko11_content_product',30);
function velocitytoko11_content_product($post){
    ?>
    <article <?php post_class('col-xl-3 col-md-4 col-6 mb-2'); ?> id="post-<?php the_ID(); ?>">
        <div class="card h-100 card-product shadow-sm border-0 overflow-hidden">
            <?php echo do_shortcode("[thumbnail width='170' height='200' crop='false' upscale='true']"); ?>
